    ...
    <div>
      ...
      {tab === "overview" && (
        <div className="mt-4 grid gap-5 lg:grid-cols-2">
          ...
          <Card>
            <CardHeader title="Latest telemetry" subtitle="Most recent sample in lighting_telemetry" />
          ...
          {samples.length === 0 ? (
            <Card>
              <EmptyState
                ...
                message={`lighting_telemetry has no samples for ${device.deviceKey} yet. Values are never generated by the UI.`}
                className="py-14"
              />
            </Card>
          ) : (
